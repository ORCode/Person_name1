...
?>
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
      <a class="dropdown-item" href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-asc">По возрастанию</a>
      <a class="dropdown-item" href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-desc">По убыванию</a>
      <a class="dropdown-item" href="view_aystopper.php?go=<?php echo $go; ?>&sort=popular">Популярные</a>
      <a class="dropdown-item" href="view_aystopper.php?go=<?php echo $go; ?>&sort=news">Новинки</a>
      <a class="dropdown-item" href="view_aystopper.php?go=<?php echo $go; ?>&sort=brand">От A до Z</a>
    </div>
  </div>
