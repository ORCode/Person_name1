  ...
  <?php
    ...
    if (mysql_num_rows($result) > 0)
    {
        ...
        $height = 300;
          ...
          echo '
             <div class="col-xl-3 col-md-6 col-sm-12 card_margin_top_grid">
                      <div class="card profile-card-5 cart_max_width">
                        ...
                        <div class="card-body pt-0 ">
                          ...
                          <div class="col-4">
                            <p><img src="/images/eye.png" /> '.$row["count"].'</p>
                          </div>
                          <div class="col-4">
                            <p><img src="/images/speech-bubble.png" /> 0</p>
                          </div>
                          <div class="col-4">
                          <a class="add-cart-style-grid" tid="'.$row["products_id"].'"><img class="img_cart_tovar" src="/images/shopping-cart.png"/> </a>
                          </div>
                          </div>
                          
                          <p class="style-price-grid text-center">Цена <strong>'.group_numerals($row["price"]).'</strong> руб.</p>
