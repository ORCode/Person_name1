...
<div class="container-fluid">
                    ...
                    <div id="category-name-product">
                        ...
                        <div class="dropdown show ">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                              <a class="dropdown-item" href="view_cat.php">Без сортировки</a>
                              <a class="dropdown-item" href="view_cat.php?cat='.$cat.' &type='.$type.'&sort=price-asc">По возрастанию</a>
                              <a class="dropdown-item" href="view_cat.php?cat='.$cat.' &type='.$type.'&sort=price-desc">По убыванию</a>
                              <a class="dropdown-item" href="view_cat.php?cat='.$cat.' &type='.$type.'&sort=popular">Популярные</a>
                              <a class="dropdown-item" href="view_cat.php?cat='.$cat.' &type='.$type.'&sort=news">Новинки</a>
                              <a class="dropdown-item" href="view_cat.php?cat='.$cat.' &type='.$type.'&sort=brand">От A до Z</a>
                            </div>
                          </div>
  ...
  else 
  {
    ...
    $num = 7; //колличество выводимого товара.
    $page = (int)$_GET['page'];              
